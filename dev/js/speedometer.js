...
export function speedometerAnimation(){
    ...
    speedometerTL.from(".medium-bars", {duration:0.05, alpha:0, ease:"none", stagger:0.1}, "+=0.5")
                .to(".medium-bars", {duration:0.05, alpha:0, reversed:true, ease:"none", stagger:0.1}, "+=0.5")
                .to(".medium-bars", {duration:0.05, alpha:1, ease: "none", stagger:0.1}, "+=0.5");
