...
export function speedometerSecondAnimation(){
    ...
    speedometerSecondTL.from(".fast-bars", {duration:0.05, alpha:0, ease:"none", stagger:0.1})
                        .to(".fast-bars", {duration:0.05, alpha:0, reversed:true, ease:"none", stagger:0.1}, "+=4");
    speedometerSecondTL.to(".medium-bars", {duration:0.05, alpha:0, reversed:true, ease:"none", stagger:0.1}, "+=3");
    speedometerSecondTL.to(".slow-bars", {duration:0.05, alpha:0, reversed:true, ease:"none", stagger:0.1}, "+=3");
